...
<html lang="en">
  ...
  <body>
    ...
    <div class="header">
      <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex justify-content-around align-items-center">
          <div class="">
            <button type="button" class="btn btn-success " onclick="window.location='{{ url("daftarjual") }}'" style="border-radius: 5px;border-color: white; border-width: 1px">Daftar Jual</button>
          </div>
          <div class="ps-3">
            <button type="button" class="btn btn-danger " onclick="window.location='{{ url("jualproduk") }}'" style="border-radius: 5px;border-color: white; border-width:1px ">+ Jual</button>
          </div>
          <div class="ps-3">
            <a href="">
    ...
    <!--Input-->
    <form action="{{ route('jualproduk') }}" method="post" enctype="multipart/form-data">
      @csrf
      <div class="container">
      ...
      <div class="tabel">
        <div>
          ...
          <div class="d-flex">
            ...
            <div>
              <div>
                <textarea name="deskripsiproduk" id="" cols="30" rows="10" class="form-control ms-5 mt-5"></textarea>
              </div>
            </div>
            <div></div>
          </div>
